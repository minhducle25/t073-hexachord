...
import DragZoomSvg from "./DragZoomSvg";
...
const TonnetzView = ({
  ...
  return (
    <div className="tonnetzView flex flex-col items-center justify-center min-h-screen">
    <div className="flex justify-center items-center">
      ...
      <p
        className={`text-center text-gray-400 italic mt-2.5 ${
          isConnected ? "hidden" : "visible"
        }`}
      >
        Not connected
      </p>
